        ...
        <tr class="border-b border-dark-border/50 hover:bg-dark-bg/50 transition-colors">
            ...
            <td class="p-4 text-right">
                <div class="flex items-center justify-end gap-2">
                    ...
                    ${!isDefault ? `
                    <button onclick="deleteModelConfig(${config.id}, '${escapeJsAttr(config.model_name)}')" class="p-2 hover:bg-red-500/20 rounded-lg transition-colors" title="Delete">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ${Object.entries(presets).map(([key, preset]) => `
                                <button type="button" onclick="applyPreset('${escapeJsAttr(key)}')"
